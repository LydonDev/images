...
Images are hosted on `ghcr.io` and exist under the `games`, `installers`, and `generic` spaces. The following logic
...
* `generic` — these are more generic images that allow different types of games or scripts to run. They're generally just
